...
.background-eye {{
    ...
    opacity: 0.25;
    filter: grayscale(1) sepia(.35) saturate(.75) contrast(1.08) brightness(.58);
    -webkit-mask-image: linear-gradient(90deg, transparent 0%, rgba(0,0,0,.30) 24%, black 60%);
    mask-image: linear-gradient(90deg, transparent 0%, rgba(0,0,0,.30) 24%, black 60%);
}}
...
.background-vignette {{
    ...
    pointer-events: none;
    background:
        radial-gradient(circle at 82% 36%, rgba(255,157,46,.05), transparent 30%),
        linear-gradient(90deg, rgba(5,5,5,1) 0%, rgba(5,5,5,.98) 48%, rgba(5,5,5,.76) 72%, rgba(5,5,5,.88) 100%),
        ...
        gr.HTML(
            ...
            <header id="hero">
                ...
                <div class="hero-badges">
                    ...
                    <span class="hero-badge">Prototip v5.0</span>
                </div>
            </header>
            """
        )
